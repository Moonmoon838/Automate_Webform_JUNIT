...
public class AutomateWebform {
    ...
    public void automateForm() throws InterruptedException {
        ...
        formElement.get(0).sendKeys("Alice"); //name
        formElement.get(1).sendKeys("01759505098"); //phone number
        ...
        String s[];
        s = currentDate.split("-");
        driver.findElement(By.id("edit-date")).sendKeys(s[2]); //date
        ...
        Thread.sleep(3000);
        formElement.get(3).sendKeys("alice@gmail.com"); //email
        formElement.get(4).sendKeys("I am a SQA Engineer"); //textbox
